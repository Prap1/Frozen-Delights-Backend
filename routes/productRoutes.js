...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetails, getVendorProducts, getAdminProducts } = require('../controllers/productController');
...
router.route('/admin').get(protect, authorize('admin'), getAdminProducts);
